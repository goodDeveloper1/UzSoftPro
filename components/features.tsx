        ...
        <FollowerPointerCard
          title={
            <div className="flex items-center gap-2">
              <span>✨</span>
              <span>Interaktiv imkoniyatlar</span>
            </div>
          }
        >
            ...
            <div className="grid grid-cols-12 gap-4 justify-center">
              ...
              >
                <div className="flex flex-col gap-4">
                  <h3 className="text-2xl leading-none font-semibold tracking-tight">Kengaytirilgan boshqaruv</h3>
                  <div className="text-md text-muted-foreground flex flex-col gap-2 text-sm">
                    <p className="max-w-[460px]">
                      Platformamiz orqali veb-sayt va ilovalaringizni qulay boshqarish, sozlash va monitoring qilish imkoniyati.
                    </p>
                  </div>
                </div>
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="flex items-center gap-8">
                        ...
                        <div className="flex flex-col gap-3">
                          {["Tez va xavfsiz", "Moslashuvchan narxlar", "Biznesga mos"].map((item, index) => (
                            <motion.div
                              key={`left-${index}`}
                        ...
                        {/* Right Column */}
                        <div className="flex flex-col gap-3">
                          {["Jamoa bilan ishlash", "Onlayn to'lov", "Texnik yordam"].map((item, index) => (
                            <motion.div
                              key={`right-${index}`}
                              className="bg-white rounded px-3 py-2 flex items-center gap-2 text-black text-sm font-medium shadow-sm"
                              initial={{ opacity: 1, x: 0 }}
              ...
              >
                <div className="flex flex-col gap-4">
                  <h3 className="text-2xl leading-none font-semibold tracking-tight">O‘zbekiston bo‘ylab xizmatlar</h3>
                  <div className="text-md text-muted-foreground flex flex-col gap-2 text-sm">
                    <p className="max-w-[460px]">
                      Bizning raqamli yechimlarimiz butun O‘zbekiston bo‘ylab har qanday biznes va tashkilot uchun mos.
                    </p>
                  </div>
                </div>
                <div className="flex min-h-[300px] grow items-start justify-center select-none">
                  <h1 className="mt-8 text-center text-5xl leading-[100%] font-semibold sm:leading-normal lg:mt-12 lg:text-6xl">
                    <span className='bg-background relative mt-3 inline-block w-fit rounded-md border px-1.5 py-0.5 before:absolute before:top-0 before:left-0 before:z-10 before:h-full before:w-full before:bg-[url("/noise.gif")] before:opacity-[0.09] before:content-[""]'>
                      <ScrambleHover
                        text="Innovatsion texnologiyalar"
                        scrambleSpeed={70}
                        maxIterations={20}
              ...
              >
                <div className="flex flex-col gap-4">
                  <h3 className="text-2xl leading-none font-semibold tracking-tight">Aqlli komponentlar</h3>
                  <div className="text-md text-muted-foreground flex flex-col gap-2 text-sm">
                    <p className="max-w-[460px]">
                      Har bir mijoz ehtiyojiga moslashadigan, animatsiya va interaktivlikka ega zamonaviy komponentlar.
                    </p>
                  </div>
                </div>
              ...
              >
                <div className="flex flex-col gap-4">
                  <h3 className="text-2xl leading-none font-semibold tracking-tight">Moslashuvchan dizayn</h3>
                  <div className="text-md text-muted-foreground flex flex-col gap-2 text-sm">
                    <p className="max-w-[460px]">
                      Har qanday qurilma va ekran o‘lchamiga moslashadigan zamonaviy va responsiv dizayn.
                    </p>
                  </div>
                </div>
                <div className="flex grow items-center justify-center select-none relative min-h-[300px] p-4">
